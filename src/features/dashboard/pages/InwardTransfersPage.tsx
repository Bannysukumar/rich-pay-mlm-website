...
export function InwardTransfersPage() {
    ...
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        snap.forEach((doc) => {
          ...
          const toUser =
            d.toUsername ?? d.toUserId ?? d.toUserDisplay ?? d.creditedToUsername ?? ''
          next.push({
            id: doc.id,
            createdAtMs,
      ...
      () => {
        setLoading(false)
        toast.error('Could not load inward transfers')
        setRows([])
      },
    )
    return () => unsub()
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title mb-0">Transfers - Inward Report</h4>
              </div>
