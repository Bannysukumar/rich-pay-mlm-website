...
exports.processDailyRoi = exports.onDepositApproved = exports.internalTransfer = exports.convertIncomeToActivation = exports.walletConvert = exports.createWithdrawal = exports.activatePackage = exports.resolveUsername = exports.listAllDownlines = exports.listDirectReferrals = exports.changeTransactionPassword = exports.updateMemberProfile = exports.registerWithProfile = void 0;
 ...
 */
const callableRuntimeOpts = { cors: true, invoker: 'public' };
...
exports.registerWithProfile = (0, https_1.onCall)(callableRuntimeOpts, async (request) => {
    ...
    if (sponsorUid) {
        await db
            ...
            .doc(sponsorUid)
            .set({ activeDirects: firestore_1.FieldValue.increment(1) }, { merge: true });
    }
...
exports.activatePackage = (0, https_1.onCall)(callableRuntimeOpts, async (request) => {
    ...
    if (deposit < amount * 0.5) {
        throw new https_1.HttpsError('failed-precondition', 'Minimum 50% of package value is required in Deposit Wallet');
    }
    ...
    const sponsorUid = beneForSponsor.data()?.sponsorUid;
    if (sponsorUid) {
        ...
        await db
            ...
            .doc(sponsorUid)
            .set({
            'wallets.cash': firestore_1.FieldValue.increment(bonus),
            sponsorBonusTotal: firestore_1.FieldValue.increment(bonus),
            workingIncomeBalance: firestore_1.FieldValue.increment(bonus),
            updatedAt: Date.now(),
        }, { merge: true });
...
exports.onDepositApproved = (0, firestore_2.onDocumentUpdated)(`${COL_DEPOSITS}/{id}`, async (event) => {
...
exports.processDailyRoi = (0, scheduler_1.onSchedule)('every 24 hours', async () => {
    const now = firestore_1.Timestamp.now();
